...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$UserStateCopyWithImpl<T, $Res, _$Loading<T>>
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$UserStateCopyWithImpl<T, $Res, _$Success<T>>
...
abstract class Success<T> implements UserState<T> {
  const factory Success(final Users data) = _$Success<T>;
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$UserStateCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'UserState<$T>.error(networkExceptions: $networkExceptions)';
  }
